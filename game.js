...
function setSetupField(key,val){ setupForm[key]=val; render(); }
...
function setupScreen(){
  return `<div class="container"><div class="topbar"><div><h1>ゲーム開始設定</h1><div class="muted">ステップ1 / 2</div></div><button class="ghost" onclick="render()">最新プレビュー</button></div>
    <div class="hero-grid">
      <div class="card">
        <div class="formrow"><label>事務所名</label><input value="${escapeHTML(setupForm.agencyName)}" oninput="setSetupField('agencyName', this.value)" maxlength="28"></div>
        <div class="formrow"><label>グループ名</label><input value="${escapeHTML(setupForm.groupName)}" oninput="setSetupField('groupName', this.value)" maxlength="24"></div>
